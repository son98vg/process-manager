...
import { DialogPcDockerComponent } from './components/dialog-components/dialog-pc-docker/dialog-pc-docker.component';
...
@NgModule({
  ...
  providers: [ProcessService, PcDockerService],
  entryComponents: [DialogPcDockerComponent],
